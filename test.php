...
$s = "<img style='display: block;margin-left:auto;margin-right:auto' src = 'http://www.thai-camp.com/img/logo.png' >" ;
    					...
    					<table class="table table-condensed" style="width:100%; padding:0 15px">
    						...
    						<tbody>
    							...
    							<tr>
    								...
    								<td style="width:15%;padding:10px 0;border-bottom:2px solid;" class="text-right">'.$qry['price'].' KD</td>
    							</tr>
    							...
    							<tr>
    								...
    								<td class="thick-line text-right" style="padding:5px">'.$qry['price'].' KD</td>
    							</tr>
