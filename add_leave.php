                        ...
                        <div class="panel">
                            <div class="panel-heading bg-primary">
                                <h4 class="panel-title">
                                    <i class="fa fa-fw fa-user"></i> Add Leave
                                </h4>
                                ...
                                <div role="tabpanel">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="Info">
                                            <div class="row">
                                              <form id="add-user-form"  method="post" action="ajax/add-leave.php"  onsubmit="return false;"  enctype="multipart/form-data" >    
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="users">
                                                                <tr>
                                                                    <td> From</td> 
                                                                    <td>
                                                                        <input type="date" name="leave_from" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>To</td>
                                                                    <td>
                                                                        <input type="date" name="leave_to" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Reason</td>
                                                                    <td>
                                                                         <textarea id="w3review" name="reason" class="form-control" rows="4" cols="50"></textarea>
                                                                    </td>
                                                                </tr>
