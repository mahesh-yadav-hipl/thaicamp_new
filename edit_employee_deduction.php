                        ...
                        <div class="panel">
                            <div class="panel-heading bg-primary">
                                <h4 class="panel-title">
                                    <i class="fa fa-fw fa-user"></i> Edit Employee Deduction
                                </h4>
                                                            ...
                                                            <table class="table table-bordered" id="users">
                                                                ...
                                                                <tr>                                                                    
                                                                    <td>Deduction Amount </td>
                                                                      <td>
                                                                        <input type="number" name="deduction_amount" value="<?php echo (int)$employee[0]['deduction_amount'];?>" class="form-control" required>
                                                                    </td>                                                                    
                                                                </tr> 
                                                                <tr>
                                                                    <td>Reason</td>
                                                                    <td>
                                                                        <textarea name="reason" class="form-control" rows="4" cols="50"><?php echo $employee[0]['reason'];?></textarea>
                                                                    </td>
                                                                </tr>
