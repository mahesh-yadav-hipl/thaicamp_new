...
$category = db_select_query("SELECT * FROM categories WHERE id = '$id'");
if(count($category) == 0){
                                ...
                                <div role="tabpanel">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="Info">
                                            <div class="row">
                                              <form id="add-user-form"  method="post" action="ajax/edit-category.php"  onsubmit="return false;"  enctype="multipart/form-data" >    
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="users">
                                                                <tr>
                                                                    <td> Category Name</td>
                                                                    <td>
                                                                        <input type="text" name="name" class="form-control" value="<?php echo $category[0]['name'];?>" require>
                                                                    </td>
                                                                </tr>
                                                                 ...
                                                                 <!-- <tr>
                                                                    ...
                                                                    <td>
                                                                      <input type="file" name="image" class="form-control"><br>
                                                                        <?php 
                                                                            // if($category[0]['image'] !=''){
                                                                            //     $url = URL.'uploaded/category/'.$category[0]['image'];
