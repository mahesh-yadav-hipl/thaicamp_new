...
?>        <aside class="right-side right-padding">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" name="payment_method" id = "payment_method">
                                                                ...
                                                                <option  <?php if(!empty($_REQUEST['payment_method'])){
                                                                        if($_REQUEST['payment_method'] == '1'){ echo 'selected'; } } ?> value="1">Knet</option>
                                                                <option  <?php if(!empty($_REQUEST['payment_method'])){
                                                                        if($_REQUEST['payment_method'] == '2'){ echo 'selected'; } } ?> value="2">Cash</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" name="report_for" id = "report_for">
                                                                ...
                                                                if($_REQUEST['report_for'] == 'New Users'){ echo 'selected'; } } ?>>New Users</option>
                                                                <option value="Finished Subscriptions" <?php if(isset($_REQUEST['report_for'])){
                                                                        if($_REQUEST['report_for'] == 'Finished Subscriptions'){ echo 'selected'; } } ?>>Finished Subscriptions</option>
                                                                <option value="Subscriptions Finished In 7 Days" <?php if(isset($_REQUEST['report_for'])){
                                                                        if($_REQUEST['report_for'] == 'Subscriptions Finished In 7 Days'){ echo 'selected'; } } ?>>Subscriptions Finished In 7 Days</option> 
                                                            
                                                                <option value="Subscriptions Finished This Month" <?php if(isset($_REQUEST['report_for'])){
                                                                        if($_REQUEST['report_for'] == 'Subscriptions Finished This Month'){ echo 'selected'; } } ?>>Subscriptions Finished This Month</option>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" name="package" id = "package">
                                                                ...
                                                                <option  <?php if(!empty($_REQUEST['package'])){
                                                                        if($_REQUEST['package'] == $package['id']){ echo 'selected'; } } ?> value="<?=$package['id']?>"><?=$package['name']?></option>
                                                                <?php }
                                                                } ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" name="class" id = "class">
                                                                ...
                                                                <option  <?php if(!empty($_REQUEST['class'])){
                                                                        if($_REQUEST['class'] == $class['id']){ echo 'selected'; } } ?> value="<?=$class['id']?>"><?=$class['name']?></option>
                                                                <?php }
                                                                } ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" name="users_status" id = "users_status">
                                                                ...
                                                                <option  <?php if(!empty($_REQUEST['users_status'])){
                                                                        if($_REQUEST['users_status'] == 'Active'){ echo 'selected'; } } ?> value="Active">Active</option>
                                                                <option  <?php if(!empty($_REQUEST['users_status'])){
                                                                        if($_REQUEST['users_status'] == 'Non Active'){ echo 'selected'; } } ?> value="Non Active">Non Active</option>
                                ...
                                if($_REQUEST['report_for'] == 'Subscriptions Finished This Month')
      {
         ...
         if($today_date <= $exp &&  $date_after_1_month >= $exp){ ?> 
                              ...
                              <?php 
                              if($_REQUEST['report_for'] != 'Subscriptions Finished This Month' && $_REQUEST['report_for'] != 'Subscriptions Finished In 7 Days'
