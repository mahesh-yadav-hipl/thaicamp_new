                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div id="owl-demo" class="owl-carousel owl-theme">
                            <div class="item">
                                <img src="img/fitness/f1.jpg" alt="slider-image" class="img-responsive">
                            </div>
                            <div class="item">
                                <img src="img/fitness/f2.jpg" alt="slider-image" class="img-responsive">
                            </div>
                            <div class="item">
                                <img src="img/fitness/f3.jpg" alt="slider-image" class="img-responsive">
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 img-responsive-alignments">
                                        <div class="ih-item circle effect3 left_to_right left-to-right-margin">
                                            <a href="profile_view.html">
                                                <div class="img">
                                                    <img src="img/fitness/jim1.jpg" alt="img" style="margin: 0 auto">
                                                </div>
                                                <div class="info">
                                                    <h3>John Doe</h3>
                                    ...
                                    <div class="col-xs-12 col-sm-6 hidden-xs img-responsive-alignments right-to-margin">
                                        <div class="ih-item circle effect3 right_to_left">
                                            <a href="profile_view.html">
                                                <div class="img">
                                                    <img src="img/fitness/jim4.jpg" alt="img">
                                                </div>
                                                <div class="info">
                                                    <h3>Natali</h3>
