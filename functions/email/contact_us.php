						...
						<table class="main" width="100%" cellpadding="0" cellspacing="0"
							...
							<tr style="box-sizing: border-box; font-size: 14px; margin: 0;">
								<td class="content-wrap"
									...
									valign="top">
									<h3>Hi Admin,</h3>
									<p>Contact Us Request FROM Hrlabindia</p>
									
                                    <table class="table" >
                                    	 <tr>
                                    	 	<td>Name:- </td><td><?=(isset($name))?$name:''?></td>
                                    	 </tr>
                                    	 <tr>
                                    	 	<td>Email:- </td><td><?=(isset($email))?$email:''?></td>
                                    	 </tr>
                                    	 <tr>
                                    	 	<td>Subject:- </td><td><?=(isset($subject))?$subject:''?></td>
                                    	 </tr>
                                    	 <tr>
                                    	 	<td>Phone:- </td><td><?=(isset($phone))?$phone:''?></td>
                                    	 </tr>
                                    	 <tr>
                                    	 	<td>Message:- </td><td><?=(isset($message))?$message:''?></td>
                                    	 </tr>
                                    </table> 
