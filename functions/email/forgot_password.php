							...
							<tr style="box-sizing: border-box; font-size: 14px; margin: 0;">
								<td class="content-wrap"
									...
									<p style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;'>
										<p class='content-block' style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif;
										box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 0px; text-align: center;'  valign='top'>
											<p>We Recieve Your Forgot Password Request</p><br>
											<p>We will contact to you shortly</p> 
											<p>Email :-  <?=(isset($email))?$email:'';?></p> 
											<p>Passowrd :-  <?=(isset($password))?$password:'';?></p> 
