                        ...
                        <div class="panel">
                            <div class="panel-heading bg-primary">
                                <h4 class="panel-title">
                                    <i class="fa fa-fw fa-user"></i> Edit Employee
                                </h4>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered" id="users">
                                                                <tr>
                                                                    <td>Name</td>
                                                                    <td>
                                                                        <input type="text" name="name" value="<?php echo $employee[0]['name'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Email</td>
                                                                    <td>
                                                                        <input type="email" name="email" value="<?php echo $employee[0]['email'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Password</td>
                                                                ...
                                                                <tr>
                                                                    <td>Salary</td>
                                                                    <td>
                                                                        <input type="number" name="salary" value="<?php echo $employee[0]['salary'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <!-- <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="number" name="subscriber_buy_price" value="<?php echo $employee[0]['subscriber_buy_price'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr> -->
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="number" name="employee_percentage" value="<?php echo $employee[0]['employee_percentage'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr> 
                                                                ...
                                                                <tr>
                                                                    <td>Phone</td>
                                                                    <td>
                                                                        <input type="number" name="mobile" value="<?php echo $employee[0]['mobile'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Date of Birth</td>
                                                                    <td>
                                                                        <input type="date" name="date_of_birth" value="<?php echo $employee[0]['date_of_birth'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Gender</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="date" name="date_of_joining"  value="<?php echo $employee[0]['date_of_joining'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Address</td>
                                                                    <td>
                                                                        <textarea name="address" class="form-control" rows="4" cols="50"><?php echo $employee[0]['address'];?></textarea>
                                                                    </td>
                                                                </tr>
                                                                 ...
                                                                 <tr>
                                                                    ...
                                                                    <td>
                                                                    <span class="text-warning">Upload Profile Image (If You want to change)</span>
