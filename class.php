                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-6">
                                                        ...
                                                        <a class="btn btn-danger default-btns" href="class.php">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <tr>
                                            <td><?=$i?></td>
                                             ...
                                             <td><?=$v['duration']?> Hour</td>
                                              <td><?=$v['capacity']?></td>
                                            <td>
                                                <a class="btn btn-primary default-btns" href="class.php?id=<?=$v['id']?>">
                                                     Edit
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-danger remove default-btns" href="#" data-table='classes' data-key='id' data-value="<?php echo $v['id'] ?>">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
