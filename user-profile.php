...
$user = db_select_query("SELECT * , CONCAT('".URL."uploaded/employee/', image) AS image FROM users where id = '$id'")[0];
}else{
...
$get_all_upcoming_packages = db_select_query("select * from upcoming_packages where user_id = '$id' ") ;
                                    ...
                                    <div class="terms">
                                        <ul class="nav nav-tabs nav-custom " role="tablist">
                                            ...
                                            <li role="presentation">
                                                <a href="#edit_profile" aria-controls="edit_profile" role="tab" data-toggle="tab">
                                                    ...
                                                    <div class="form-group pad-top">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new thumbnail">
                                                                ...
                                                                ?>
                                                                <img src="<?=$image?>"  alt="profile" style="border-radius:50%;width: 150px;height: 150px;">
                                                            </div>
                                                ...
                                                <table class="table table-bordered" id="fitness-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                    <td><?= $pck_name ?></td>
                                                                    <td><?= $pck_start_date ?></td>
                                                                    <td><?= date("d-m-Y" , strtotime($exp)) ; ?></td>
                                                                    <td><?= $drt ?> Days</td>
                                                                    <td><?php if($get_all_classes) {
                                                                                foreach($get_all_classes as $k =>$v){
                                                                                    $sr = explode(",",$user['class_id']);
                                                                                    if(in_array($v['id'], $sr)){ 
                                                                            ?>
                                                          ...
                                                          <input type="hidden" name="table" value="users" >   
                                                            ...
                                                            <table class="table table-bordered" id="users">
                                                                ...
                                                                <tr>
                                                                    <td>E-mail</td>
                                                                    <td>
                                                                        <input type="email" name="email" value="<?php echo $user['email'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Mobile</td>
                                                                    <td>
                                                                       <input type="number" name="mobile" value="<?php echo $user['mobile'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>DOB</td>
                                                                    <td>
                                                                       <input type="date" name="date_of_birth" value="<?php echo $user['date_of_birth'];?>" class="form-control" require>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Gender</td>
