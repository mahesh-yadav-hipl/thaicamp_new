                            ...
                            <div class="row">
                                <?php 
                                    ...
                                    // for production
                                        ...
                                        $api_key = 'd04d6a6319739b7e149956d6382ecbb6717f0cee';
                                         $success_url = 'http://localhost/thaicamp/knet_payment_suceess.php';
                                         $error_url = 'http://localhost/thaicamp/knet_payment_error.php';
                                        $test_mode = 0;
                                    ...
                                    // Username : coachgazi
                                    // Password : GcRDB5[NNMnP
                                    // API Key : d04d6a6319739b7e149956d6382ecbb6717f0cee
                                    // Encrypted API Key : $2y$10$n6OzdqGWiGR2ahDFbtjCcucYDJ3IjcCAJTrO5I.PnJjIpV7hYIMBa
                                    // Test Mode : 0
                             ...
                             // 'api_key'=>$api_key, // in sandbox request
                                /////'api_key' =>password_hash('API_KEY',PASSWORD_BCRYPT), //In production mode, please pass API_KEY with BCRYPT function
                                 ...
                                 'api_key' =>password_hash($api_key,PASSWORD_BCRYPT), //In production mode, please pass API_KEY with BCRYPT function
                               // 'api_key' =>'$2y$10$n6OzdqGWiGR2ahDFbtjCcucYDJ3IjcCAJTrO5I.PnJjIpV7hYIMBa', //In production mode, please pass API_KEY with BCRYPT function
