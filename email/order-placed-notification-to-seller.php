						...
						<table class="main" width="100%" cellpadding="0" cellspacing="0"
							...
							<tr style="box-sizing: border-box; font-size: 14px; margin: 0;">
								<td class="alert alert-warning"
									...
									<img style="width:330px;" src="<?= SITE_LOGO;?>">
								</td>
							</tr>
							<tr style="box-sizing: border-box; font-size: 14px; margin: 0;">
							...
							<tr style="box-sizing: border-box; font-size: 14px; margin: 0;">
								<td class="content-wrap"
									...
									valign="top">
									<h3>Hi <?= $name?$name:'';?>,</h3>
									<p>Welcome to Swipaa.com</p>
									<p>New order has been placed.</p>
									<p>For more further details of your order, Please click the link given below.</p>
									<p>
										<a href='<?= $link?$link:'';?>' class='btn-primary' itemprop='url' style='font-family: Helvetica Neue,Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #ff991b; margin: 0; border-color: #ff991b; border-style: solid; border-width: 8px 16px;'>
											Track Your Order
										</a>
									</p>
